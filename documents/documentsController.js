myApp.controller('documentsCtrl', ['$scope', '$log','$rootScope','$stateParams', function($scope, $log, $rootScope,$stateParams) {
    ...
    $scope.documents = $scope.documentsModel[0][$stateParams.secid];
